 ...
 */
exports.del = function(zk,path,cb){
 ...
 */
exports.get = function(zk,path,cb,w_cb){
  if(w_cb === undefined){
 ...
 * @param {function} cb   回调函数
 */
exports.set = function (zk,path,obj,cb){
 ...
 * @param {function} w_cb  watch回调函数
 */
exports.ifExist = function(zk,path,cb,w_cb){
  if(w_cb === undefined){
 ...
 */
exports.getChildren = function(zk,path,cb,w_cb,signal){
  if(w_cb === undefined){
 ...
 */
exports.createNode = function(zk,path,obj,type,cb){
